...
OUTROOT = "artifacts/router_optionB_boolq"
...
for seed in SEEDS:
    dev_path = f"data/router_splits_boolq_seeds/seed{seed}/dev.jsonl"
    test_path = f"data/router_splits_boolq_seeds/seed{seed}/test.jsonl"
