...
Oracle & 0.6133$\pm$0.0503 (554$\pm$35, 3.08$\pm$0.13) & 0.6133$\pm$0.0503 (554$\pm$35, 3.08$\pm$0.13) & 0.6133$\pm$0.0503 (554$\pm$35, 3.08$\pm$0.13) & 0.6133$\pm$0.0503 (554$\pm$35, 3.08$\pm$0.13) \\
\bottomrule
\end{tabularx}
\caption{BoolQ test performance across compute tiers (accuracy; mean tokens and mean steps in parentheses). Adaptive policies are tuned on dev to match the fixed tier's mean token compute in expectation; values are mean$\pm over three split seeds.}
