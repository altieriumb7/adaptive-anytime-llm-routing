...
\toprule
Policy (validation, mean$\pm$std over seeds, sample std) & B1 & B2 & B3 & B4 \\
\midrule
...
\bottomrule
\end{tabularx}
\caption{Validation performance across compute tiers (accuracy; mean tokens and mean steps in parentheses). Values are mean$\pm$std over three split seeds (sample std).}
